...
function Register() {
    ...
    const validateForm = () => {
        ...
        if (!form.username.trim()) {
            ...
            newErrors.username = 'Username must be least 3 characters ';
        }
        ...
        if (!form.password) {
            ...
            newErrors.password = 'Password must be a leates 6'
        }
    ...
    const getPasswordStrength = () => {
        if (form.password.length.length === 0) return {strength: 0, text: '', color: 'gray'};
                        ...
                        <div className="space-y-2">
                            <div className="flex justify-between text-xs">
                                ...
                                <span className={`font-medium ${
                                    ...
                                    passwordStrength.color === 'yellow' ? 'text-yellow-500': 'text-green-500'
                                }`}>
